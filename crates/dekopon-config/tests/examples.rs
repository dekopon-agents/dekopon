...
//! `xaviers-conditional-write` may approve, and neither fact is a property of the catalog — it is a
...
#[test]
fn the_conditional_write_example_matches_the_probe_provider_manifest() {
    ...
    let agent = catalog
        ...
        .expect("the conditional-write agent exists");
    ...
    assert!(
        ...
        "the standing orders are what make this a review rather than a reflex"
    );
