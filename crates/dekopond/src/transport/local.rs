...
/// These socket checks are kept rather than simplified because a socket another user could reach or
/// replace would let them forge the subject claim this transport trusts.
