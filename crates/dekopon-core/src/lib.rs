...
pub const RESERVED_COMMAND_WORDS: &[&str] = &[
    ...
    "export", "false", "fg", "fi", "for", "function", "getopts", "grep", "if", "in", "jobs", "jq", "kill",
    "local", "printf", "read", "return", "sed", "select", "set", "shift", "sleep", "sort", "source",
    "test", "then", "trap", "true", "uniq", "unset", "until", "wait", "wc",
    "while", "xargs",
];
