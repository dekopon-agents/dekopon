...
```console
gh release download v0.14.0 --repo dekopon-agents/dekopon \
  --pattern 'dekopon-0.14.0-aarch64-apple-darwin.tar.gz*'
shasum -a 256 -c dekopon-0.14.0-aarch64-apple-darwin.tar.gz.sha256
gh attestation verify --repo dekopon-agents/dekopon \
  dekopon-0.14.0-aarch64-apple-darwin.tar.gz
tar xzf dekopon-0.14.0-aarch64-apple-darwin.tar.gz
```
