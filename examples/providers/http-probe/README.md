...
A minimal Rust provider that composes `dekopon:provider@0.3.0` with the `dekopon:http/client@1.0.0` import. It validates caller-generated provider worlds and the broker component host's authorized path.
