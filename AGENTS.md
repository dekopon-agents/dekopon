...
| The session engine: bootstrap, history and context bounds, checkpoints, accounting, model/effort controls, or dispatch activity | [`docs/harness.md`](docs/harness.md): the unprivileged runtime's contract, its bounds, and what a checkpoint is not |
