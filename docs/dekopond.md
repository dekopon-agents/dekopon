...
total, or that observes a slot no park could have produced, is refused, with the remaining backoff
named. Unknown creation never retries. Platform pacing can
