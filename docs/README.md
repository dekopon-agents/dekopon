...
execution-aware history/checkpoints, model controls, strict accounting and remaining integration
...
| The session engine: bootstrap, history and context bounds, checkpoints, accounting, model/effort controls, or dispatch activity | [`harness.md`](harness.md) | Records the unprivileged runtime's contract, its bounds, and what a checkpoint is not. |
