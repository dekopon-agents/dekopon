...
- optional runner OTLP export sends generated performance spans and stable lifecycle events to an operator-selected endpoint, but omits prompts, model responses, tool-call IDs/arguments, provider input/output, credentials, broker socket paths, and raw errors;
