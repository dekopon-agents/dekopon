...
- `dekopon-run`: Clap CLI, direct invocation reports, bounded prompt loop, sandboxed script execution, local Chrome traces, correlated OTLP/HTTP traces and audit-safe lifecycle logs, and explicit unprivileged broker capability/invocation client.
